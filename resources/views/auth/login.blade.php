...
<div class="animated bounceInDown">
  <div class="container">
    ...
    <form method="POST" action="{{ route('login') }}" name="form1" class="box" onsubmit="return checkStuff()">
      ...
      <img class="mt-8" src="{{asset('assets/img/logo.png')}}" width="250" alt="">
        ...
        <a href="{{ route('password.request') }}" class="forgetpass">¿Contraseña olvidada?</a>
...
<link href="{{asset('assets/css/login.css')}}?v=1993.0.2" rel="stylesheet">
