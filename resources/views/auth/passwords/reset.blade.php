...
<div class="animated bounceInDown">
  ...
  <div class="container">
    ...
    <form method="POST" action="{{ route('password.update') }}" name="form1" class="box" onsubmit="return checkStuff()">
        @csrf
        ...
        <input placeholder="{{ __('Password') }}" id="pwd" type="password" class="@error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
        ...
        <i class="typcn typcn-eye" id="eye"></i>
        <input placeholder="{{ __('Confirm Password') }}" id="pwd" type="password" name="password_confirmation" required autocomplete="new-password">
        
        <input type="submit" value="Restablecer contraseña" class="btn1">
      </form>
        <a href="register" class="dnthave">¿No tienes una cuenta? Registrate</a>
  </div> 
</div>
