      ...
      <section id="contact">
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-12 col-lg-6 col-xl-7 mb-4 order-0 order-sm-0"><a class="logo-footer fs-7" href="index.html"><span class="text-primary fw-bolder">Mars</span><span class="fw-thin text-300">Game</span></a>
